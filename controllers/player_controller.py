...
class PlayerController:
    ...
    def add():
            ...
            if result != None:
                ...
                print(f"\n {player_data['firstname']} {player_data['lastname']} has been add to the database.") 

        
    @staticmethod
    def update_by_id():

        #methode de class permettant l'edition d'un joueur déjà présent dans la database
